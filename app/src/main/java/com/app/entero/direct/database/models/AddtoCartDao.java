...
*/
public class AddtoCartDao extends AbstractDao<AddToCart, Long> {

    public static final String TABLENAME = "AddtoCartDao";

    /**
     * Properties of entity AddToCart.<br/>
    ...
    public AddtoCartDao(DaoConfig config) {
        super(config);
    }
    
    public AddtoCartDao(DaoConfig config, DaoSession daoSession) {
    ...
    @Override
    protected final void bindValues(DatabaseStatement stmt, AddToCart entity) {
        stmt.clearBindings();
    ...
    @Override
    protected final void bindValues(SQLiteStatement stmt, AddToCart entity) {
        stmt.clearBindings();
    ...
    @Override
    public AddToCart readEntity(Cursor cursor, int offset) {
        AddToCart entity = new AddToCart( //
    ...
    @Override
    public void readEntity(Cursor cursor, AddToCart entity, int offset) {
    ...
    @Override
    protected final Long updateKeyAfterInsert(AddToCart entity, long rowId) {
        entity.setId(rowId);
        return rowId;
    }
    
    @Override
    public Long getKey(AddToCart entity) {
        if(entity != null) {
            return entity.getId();
        } else {
            return null;
    ...
    @Override
    public boolean hasKey(AddToCart entity) {
