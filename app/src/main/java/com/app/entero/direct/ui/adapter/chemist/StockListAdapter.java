...
public class StockListAdapter extends RecyclerView.Adapter<StockListAdapter.HolderNavigation> {
    ...
    public StockListAdapter(Activity activity, OnItemRecycleClickListener onItemRecycleClickListener, ArrayList<StockListModel> mOfferList) {
    ...
    public void onBindViewHolder(@NonNull HolderNavigation holderNavigation, int position) {
        ...
        holderNavigation.stocklistId_Tv.setText(mStockListModel.getStockListId());
