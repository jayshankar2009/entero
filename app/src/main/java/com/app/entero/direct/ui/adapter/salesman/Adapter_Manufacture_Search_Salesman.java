...
public class Adapter_Manufacture_Search_Salesman extends RecyclerView.Adapter<Adapter_Manufacture_Search_Salesman.MyViewHolder> {
    ...
    public Adapter_Manufacture_Search_Salesman(Context context, ArrayList<Salesman_Product_Search_Model> data) {
        this.data = data;
