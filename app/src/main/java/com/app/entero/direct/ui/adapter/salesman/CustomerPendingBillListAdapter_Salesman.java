...
public class CustomerPendingBillListAdapter_Salesman extends RecyclerView.Adapter<CustomerPendingBillListAdapter_Salesman.MyViewHolder> {
...
public static class MyViewHolder extends RecyclerView.ViewHolder {
    ...
    public CustomerPendingBillListAdapter_Salesman(ArrayList<Outstandings> data) {
        this.dataSet = data;
    }
    @Override
    public MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext())
                .inflate(R.layout.salesman_cartview_customer_pending_bill_list_item, parent, false);

        view.setOnClickListener(CustomerPendingBillFragment_Salesman.customerPendingBillOnClickListener);
